...
public class AuthenticationService : IAuthenticationService
{
    ...
    private AppAuthenticationState _currentState;

    /// <summary>
    /// Event triggered when authentication state changes
    /// </summary>
    public event Action<AppAuthenticationState>? AuthenticationStateChanged;

    /// <summary>
    /// Gets the current authentication state
    /// </summary>
    public AppAuthenticationState CurrentState => _currentState;
        ...
        ILogger<AuthenticationService> logger)
    {
        ...
        _logger = logger;
        _currentState = new AppAuthenticationState();
    }
