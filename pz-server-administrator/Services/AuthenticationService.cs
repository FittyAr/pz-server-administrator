...
public class AuthenticationService : IAuthenticationService
{
    ...
    public async Task<List<AuthUser>> GetAllUsersAsync()
    {
        try
        {
            ...
            return config.Users ?? new List<AuthUser>();
        }
        catch (Exception ex)
        {
    ...
    public async Task<bool> UpdateUserAsync(string username, string? newPassword = null, UserRole? newRole = null, bool? isActive = null)
    {
        try
        {
            var config = _configurationService.GetConfiguration();
